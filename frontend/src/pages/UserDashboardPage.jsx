...
const UserDashboardPage = () => {
  ...
  // Function to track bus - Navigate to bus tracking page
  const navigateToBusTracking = (busId) => {
    // In a real app, you'd use React Router:
    // history.push(`/bus-tracking/${busId}`);
    
    // For this example, we'll just alert
    alert(`Navigating to bus tracking for Bus ID: ${busId}`);
    // You would typically use React Router for navigation:
    // window.location.href = `/bus-tracking/${busId}`;
  };
